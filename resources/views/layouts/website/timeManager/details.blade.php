        ...
        <div class=" col ">
          <div class="card">
            <div class="card-header bg-transparent">
              ...
              <h5 style="color: rgb(150, 18, 62)"><span style="color: rgb(13, 110, 29)">Đi làm: {{$working_details->count()}}</span> | <span style="color: rgb(32, 185, 255)">Phép: {{$on_leave->count()}}</span> | Nghỉ tự do: {{31 - $working_details->count() - $on_leave->count()}}</h5>
